                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="kategori_id" id="kategori_id" class="select2" style="width: 100%" required>
                                        @if($record->kategori)
                                        <option value="{{ $record->kategori_id }}">{{ $record->kategori->nama }}</option>
                                        @endif
                                    </select>
                                    @error('kategori_id')
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('tgl_diterima') is-invalid @enderror" id="tgl_diterima" name="tgl_diterima" value="{{ $record->tgl_diterima }}" required>
                                    @error('tgl_diterima')
                                    <div class="invalid-feedback">
                                        <i class="bx bx-radio-circle"></i>
                                        {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('isi_yg_disita') is-invalid @enderror" id="isi_yg_disita" name="isi_yg_disita" value="{{ $record->isi_yg_disita }}">
                                    @error('isi_yg_disita')
                                    <div class="invalid-feedback">
                                        <i class="bx bx-radio-circle"></i>
                                        {{ $message }}
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="asrama_id" id="asrama_id" class="select2" style="width: 100%" required>
                                        @if($record->asrama)
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="penerima_id" id="penerima_id" class="select2" style="width: 100%" required>
                                        @if($record->penerima)
                                        <option value="{{ $record->penerima_id }}">({{ $record->penerima->nis }}) {{ $record->penerima->nama }}</option>
                                        @endif
                                    </select>
                                    @error('penerima_id')
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('pengirim') is-invalid @enderror" id="pengirim" name="pengirim" value="{{ $record->pengirim }}" required>
                                    @error('pengirim')
                                    <div class="invalid-feedback">
                                        <i class="bx bx-radio-circle"></i>
                                        {{ $message }}
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" value="belum" id="statusBelum"  @if($record->status == \App\Models\TPaket::STATE_BELUM) checked @endif>
                                        <label class="form-check-label" for="statusBelum">
                                            Belum Diambil
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" value="diambil" id="statusDiambil" @if($record->status == \App\Models\TPaket::STATE_DIAMBIL) checked @endif>
